package com.example.saravanan.sample;
    ...
    public class Main7Activity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(Main7Activity.this, android.R.layout.simple_spinner_dropdown_item, items1);
            dropdown1.setAdapter(adapter);


            dropdown2 = (Spinner) findViewById(R.id.spinner21);
            ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(Main7Activity.this, android.R.layout.simple_spinner_dropdown_item, items1);
            dropdown2.setAdapter(adapter1);


            dropdown3 = (Spinner) findViewById(R.id.spinner31);
            ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(Main7Activity.this, android.R.layout.simple_spinner_dropdown_item, items1);
            dropdown3.setAdapter(adapter2);


            dropdown4 = (Spinner) findViewById(R.id.spinner41);
            ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(Main7Activity.this, android.R.layout.simple_spinner_dropdown_item, items1);
            dropdown4.setAdapter(adapter3);


            dropdown5 = (Spinner) findViewById(R.id.spinner51);
            ArrayAdapter<String> adapter4 = new ArrayAdapter<String>(Main7Activity.this, android.R.layout.simple_spinner_dropdown_item, items1);
            dropdown5.setAdapter(adapter4);


            dropdown6 = (Spinner) findViewById(R.id.spinner61);
            ArrayAdapter<String> adapter5 = new ArrayAdapter<String>(Main7Activity.this, android.R.layout.simple_spinner_dropdown_item, items1);
            dropdown6.setAdapter(adapter5);


            dropdown7 = (Spinner) findViewById(R.id.spinner71);
            ArrayAdapter<String> adapter6 = new ArrayAdapter<String>(Main7Activity.this, android.R.layout.simple_spinner_dropdown_item, items1);
            dropdown7.setAdapter(adapter6);


            dropdown8 = (Spinner) findViewById(R.id.spinner81);
            ArrayAdapter<String> adapter7 = new ArrayAdapter<String>(Main7Activity.this, android.R.layout.simple_spinner_dropdown_item, items1);
            dropdown8.setAdapter(adapter7);


            dropdown9 = (Spinner) findViewById(R.id.spinner91);
            ArrayAdapter<String> adapter8 = new ArrayAdapter<String>(Main7Activity.this, android.R.layout.simple_spinner_dropdown_item, items1);
